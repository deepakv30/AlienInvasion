"""Main game loop and coordination for Alien Invasion."""
...
from alien_invasion.sprites import Alien, Bullet, Ship
...
class AlienInvasion:
    ...
    def _update_aliens(self) -> None:
        """Check fleet edges, then update all alien positions."""
    ...
    def _change_fleet_direction(self) -> None:
        """Drop the entire fleet and reverse its direction."""
        for alien in self.aliens.sprites():
            alien.rect.y += self.settings.fleet_drop_speed
        self.settings.fleet_direction *= -1

    def _update_screen(self) -> None:
        """Redraw the screen and flip to the new frame."""
